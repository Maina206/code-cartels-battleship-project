...
function visualGame(elementID) {
    ...
    placeShip(elementID, ships[0], 'D-3', 'horizontal'); 
    placeShip(elementID, ships[1], 'F-6', 'vertical');   
    placeShip(elementID, ships[2], 'F-9', 'vertical');
    placeShip(elementID, ships[3], 'J-3', 'horizontal');   
    placeShip(elementID, ships[4], 'B-7', 'horizontal');
